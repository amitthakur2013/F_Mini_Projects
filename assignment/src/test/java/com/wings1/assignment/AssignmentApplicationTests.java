...
import com.wings1.assignment.models.Product;
import com.wings1.assignment.models.User;
import com.wings1.assignment.repo.CartProductRepo;
import com.wings1.assignment.repo.CartRepo;
import com.wings1.assignment.repo.CategoryRepo;
import com.wings1.assignment.repo.ProductRepo;
import com.wings1.assignment.repo.UserRepo;
...
class AssignmentApplicationTests {
	...
	@Test
	@Order(11)
	public void checkProductRemovedFromCart() throws Exception {
		Cart c = cartRepo.findById(1).get();
	...
	public void checkUserCart() throws Exception {
		...
		assertEquals("jackie", c.getUser().getUsername());
	}
